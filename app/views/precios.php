    ...
    <body>
        ...
        <div id="content" role="main">
            <section class="section swatch-red-white">
                <div class="container">
                    <header class="section-header underline text-center">
                        <h1 class="headline hyper hairline">Pricing options</h1>
                    </header>
                    <div class="row">
                        <div class="col-md-4  text-default">
                            <div class="pricing-col 
                                        ">
                                <h2 class="pricing-head">Standard</h2>
                        ...
                        <div class="col-md-4  text-default">
                            <div class="pricing-col 
                                        ">
                                <h2 class="pricing-head">Advanced</h2>
                                <div class="pricing-body">
                                    <div class="pricing-price">
                                        <div class="overlay">
                                            <h4>
            ...
            <section class="section swatch-white-red has-top">
                ...
                <div class="container">
                    <header class="section-header underline text-center">
                        <h1 class="headline super hairline">What do you get?</h1>
                    </header>
                    <div class="row">
                        <div class="col-md-12  text-default">
                            <ul class="list-unstyled vertical-icon-border">
                                <li class="row">
                                    <div class="col-md-3">
                                        <div class="box-round">
                                    ...
                                    <div class="col-md-9">
                                        <h2 class="bordered-header small-screen-center">Rocket speed</h2>
                                        <p class="text-left">
                                ...
                                <li class="row">
                                    ...
                                    <div class="col-md-9">
                                        <h2 class="bordered-header small-screen-center">24/7 Support</h2>
                                        <p class="text-left">
                                            If you can keep your head when all about you are losing theirs and blaming it on you; If you can trust yourself when all men doubt you, but make allowance for their doubting too; if you can wait and not be tired by waiting,or being lied about, don't deal
                                            in lies, or being hated, don't give way to hating, and yet don't look too good, nor talk too wise; if you can dream — and not make dreams your master; if you can think — and not make thoughts your aim; if you
                                            can meet with Triumph and Disaster and treat those two impostors just the same.
                                ...
                                <li class="row">
                                    <div class="col-md-3">
                                        <div class="box-round">
                                            <div class="box-dummy"></div>
                                            <a class="box-inner " href="single-service.html">
                                                <i class="fa fa-android" data-animation="tada"></i>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <h2 class="bordered-header small-screen-center">Mobile support</h2>
                                        <p class="text-left">
                                            If you can keep your head when all about you are losing theirs and blaming it on you; If you can trust yourself when all men doubt you, but make allowance for their doubting too; if you can wait and not be tired by waiting,or being lied about, don't deal
                                            in lies, or being hated, don't give way to hating, and yet don't look too good, nor talk too wise; if you can dream — and not make dreams your master; if you can think — and not make thoughts your aim; if you
                                            can meet with Triumph and Disaster and treat those two impostors just the same.
                                ...
                                <li class="row">
                                    <div class="col-md-3">
                                        <div class="box-round">
                                            <div class="box-dummy"></div>
                                            <a class="box-inner " href="single-service.html">
                                                <i class="fa fa-star" data-animation="tada"></i>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <h2 class="bordered-header small-screen-center">5 star services</h2>
                                        <p class="text-left">
                                            If you can keep your head when all about you are losing theirs and blaming it on you; If you can trust yourself when all men doubt you, but make allowance for their doubting too; if you can wait and not be tired by waiting,or being lied about, don't deal
                                            in lies, or being hated, don't give way to hating, and yet don't look too good, nor talk too wise; if you can dream — and not make dreams your master; if you can think — and not make thoughts your aim; if you
                                            can meet with Triumph and Disaster and treat those two impostors just the same.
