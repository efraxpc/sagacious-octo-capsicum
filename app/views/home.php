...
<html lang="en" data-ng-app = 'app' ng-controller="InicioController">
    ...
    <body >
        ...
        <div id="content" role="main">
            <!--Revolution slider-->
            <section class="section swatch-red-white section-nopadding" ng-init="obtener_textos_e_imagenes_diapositiva();">
            ...
            <section class="section swatch-white-red has-top">
                ...
                <div class="container">
                    <header class="section-header underline">
                        <h1 class="headline super hairline">How much does it cost?</h1>
        ...
        <script src="angular/front/app.js"></script>
